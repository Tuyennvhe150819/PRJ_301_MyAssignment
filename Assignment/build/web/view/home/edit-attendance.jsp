        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title text-uppercase mb-0">Edit attendance</h5>
                        </div>
                        <div class="table-responsive">
                            ...
                            <form action="edit-attendance" method="POST">
                                        ...
                                        <c:forEach items="${students}" var="S">                                        
                                            <tr>
                                                ...
                                                <td>
                                                    <fieldset>
                                                        <label>
                                                            <input type="radio" name="${S.id}" value="absent">    
                                                            absent
                                                        </label>
                                                        &nbsp;
                                                        <label>
                                ...
                                <input class="float-right btn-outline-success" style="margin-right: 500px; padding: 0 16px" type="submit" value="Edit" />
